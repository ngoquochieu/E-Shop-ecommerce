...
function ShowProductHome() {
    ...
    function renderProductHome() {
            return products.map(product => {
                let img = `http://localhost:8080/laravel/public/upload/user/product/${product.id_user}/${JSON.parse(product.image)[0]}`
				let productDetail = `/product/detail/${product.id}`
                return <div className="col-sm-4">
                    <div className="product-image-wrapper">
                        ...
                        <div className="product-overlay">
                            ...
                            <h2>${product.price}</h2>
                            <p>{product.name}</p>
                            <a href="#" className="btn btn-default add-to-cart" onClick={handle}><i className="fa fa-shopping-cart"></i>Add to cart</a>
                        </div>
                        </div>
                        </div>
                        <div className="choose">
                            <ul className="nav nav-pills nav-justified">
                                ...
                                <li><Link to={productDetail}><i className="fa fa-plus-square"></i>More</Link></li>
                            </ul>
                        </div>
                    </div>
                </div>
